...
minetest.register_node("madblocks:light", {
	drawtype = "glasslike",
	tiles = {"madblocks_spotlights_inv.png"},
...
minetest.register_node("madblocks:searchlight", { 
	...
	drawtype = "plantlike", 
	tiles = {'madblocks_searchlight.png'}, 
...
minetest.register_node("madblocks:spotlight", {
	...
	tiles = { "madblocks_spotlights_top.png", "madblocks_spotlights_side.png", "madblocks_spotlights_side.png"},
