...
--		     visual = "plant",
		     visual = "cube",
		     textures = {"pushable_block_moveblock.png","pushable_block_moveblock.png","pushable_block_moveblock.png","pushable_block_moveblock.png","pushable_block_moveblock.png","pushable_block_moveblock.png"},
			...
			on_rightclick = function(self,clicker)
				if self.linkedplayer == nil then
					...
					clicker:link(self.object,{x=0,y=0.5,z=0})
	...
	minetest.register_craftitem("pushable_block:moveblock", {
		image = "pushable_block_moveblock.png",
	...
	drawtype = "raillike",
	tiles = {"pushable_block_slider.png", "pushable_block_slider.png", "pushable_block_slider.png", "pushable_block_slider.png"},
	...
	drawtype = "raillike",
	tiles = {"pushable_block_booster.png", "pushable_block_booster.png", "pushable_block_booster.png", "pushable_block_booster.png"},
