...
minetest.register_node( 'riventest:door3_a_o', {
	Description         = 'Top Open Door',
	drawtype            = 'signlike',
	tile_images         = { 'rivendoor3_a_r.png' },
...
minetest.register_node( 'riventest:door3_b_o', {
	Description         = 'Bottom Open Door',
	drawtype            = 'signlike',
	tile_images         = { 'rivendoor3_b_r.png' },
...
GLOWLIKE('rt15','Riven Testnode 15')
...
minetest.register_node("riventest:rt16", {
	...
	drawtype = "signlike",
	tile_images = {"riventest_rt16.png"},
...
minetest.register_node("riventest:water_flowing", {
	...
	tile_images = {"riventest_altwater.png"},
	alpha = WATER_ALPHA,
	paramtype = "light",
--	light_source = 8,	
	walkable = false,
