...
minetest.register_node("default:tree", {
	...
	is_ground_content = true,
	groups = {snappy=2,choppy=2,oddly_breakable_by_hand=1,flammable=2,tree=1},
...
minetest.register_abm(
		...
		minetest.env:add_node(pos_dn, {name="default:apple"})
		return true
		end            	
        end,
})
